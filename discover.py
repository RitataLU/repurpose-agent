...
def write_data_py(gold_standard, gold_features, orphan_genes):
    ...
    lines = [
        ...
        "GOLD_GENE_SET = set(GOLD_STANDARD.keys())",
        "",
        "# Real biological features for gold genes (from Open Targets + PubMed).",
        "# Used as the reference centroid for Spearman evaluation.",
        "GOLD_FEATURES = " + json.dumps(gold_features, indent=4),
        "",
        "# GWAS orphan genes — no approved drug, enriched with biological features.",
...
FALLBACK_GOLD_FEATURES = {
    "HMGCR":  {"gwas_pval_log10": 21.6, "n_gwas_studies": 8,  "disease_area": "cardiovascular", "disease_name": "coronary artery disease",    "burden_daly_m": 182.0, "open_targets_score": 0.85, "druggability_score": 0.90, "eqtl_effect": 0.64, "mr_z_score": 5.2, "tissue_specificity": 0.52, "ppi_degree": 180, "pubmed_count_5yr": 2200, "data_source": "fallback_gold"},
    "PCSK9":  {"gwas_pval_log10": 20.4, "n_gwas_studies": 7,  "disease_area": "cardiovascular", "disease_name": "coronary artery disease",    "burden_daly_m": 182.0, "open_targets_score": 0.82, "druggability_score": 0.90, "eqtl_effect": 0.61, "mr_z_score": 4.8, "tissue_specificity": 0.52, "ppi_degree": 110, "pubmed_count_5yr": 1800, "data_source": "fallback_gold"},
    "GLP1R":  {"gwas_pval_log10": 23.4, "n_gwas_studies": 9,  "disease_area": "metabolic",      "disease_name": "type 2 diabetes",            "burden_daly_m": 42.0,  "open_targets_score": 0.80, "druggability_score": 0.90, "eqtl_effect": 0.66, "mr_z_score": 5.0, "tissue_specificity": 0.44, "ppi_degree": 110, "pubmed_count_5yr": 1400, "data_source": "fallback_gold"},
    "KCNJ11": {"gwas_pval_log10": 18.0, "n_gwas_studies": 7,  "disease_area": "metabolic",      "disease_name": "type 2 diabetes",            "burden_daly_m": 42.0,  "open_targets_score": 0.75, "druggability_score": 0.90, "eqtl_effect": 0.57, "mr_z_score": 4.3, "tissue_specificity": 0.44, "ppi_degree": 110, "pubmed_count_5yr": 900, "data_source": "fallback_gold"},
    "DRD2":   {"gwas_pval_log10": 25.5, "n_gwas_studies": 11, "disease_area": "psychiatric",    "disease_name": "schizophrenia",              "burden_daly_m": 13.0,  "open_targets_score": 0.88, "druggability_score": 0.90, "eqtl_effect": 0.72, "mr_z_score": 5.6, "tissue_specificity": 0.71, "ppi_degree": 180, "pubmed_count_5yr": 2800, "data_source": "fallback_gold"},
    "HTR2A":  {"gwas_pval_log10": 18.3, "n_gwas_studies": 6,  "disease_area": "psychiatric",    "disease_name": "schizophrenia",              "burden_daly_m": 13.0,  "open_targets_score": 0.79, "druggability_score": 0.90, "eqtl_effect": 0.58, "mr_z_score": 4.4, "tissue_specificity": 0.71, "ppi_degree": 110, "pubmed_count_5yr": 1100, "data_source": "fallback_gold"},
    "TNF":    {"gwas_pval_log10": 26.4, "n_gwas_studies": 12, "disease_area": "immune",         "disease_name": "inflammatory bowel disease", "burden_daly_m": 3.0,   "open_targets_score": 0.91, "druggability_score": 0.90, "eqtl_effect": 0.75, "mr_z_score": 5.9, "tissue_specificity": 0.38, "ppi_degree": 180, "pubmed_count_5yr": 4200, "data_source": "fallback_gold"},
    "IL23A":  {"gwas_pval_log10": 21.0, "n_gwas_studies": 8,  "disease_area": "immune",         "disease_name": "inflammatory bowel disease", "burden_daly_m": 3.0,   "open_targets_score": 0.83, "druggability_score": 0.90, "eqtl_effect": 0.63, "mr_z_score": 4.9, "tissue_specificity": 0.38, "ppi_degree": 110, "pubmed_count_5yr": 1200, "data_source": "fallback_gold"},
    "LRRK2":  {"gwas_pval_log10": 18.9, "n_gwas_studies": 7,  "disease_area": "neurological",   "disease_name": "Parkinson's disease",        "burden_daly_m": 28.0,  "open_targets_score": 0.77, "druggability_score": 0.90, "eqtl_effect": 0.59, "mr_z_score": 4.5, "tissue_specificity": 0.78, "ppi_degree": 110, "pubmed_count_5yr": 1600, "data_source": "fallback_gold"},
    "SNCA":   {"gwas_pval_log10": 17.7, "n_gwas_studies": 6,  "disease_area": "neurological",   "disease_name": "Parkinson's disease",        "burden_daly_m": 28.0,  "open_targets_score": 0.74, "druggability_score": 0.90, "eqtl_effect": 0.56, "mr_z_score": 4.2, "tissue_specificity": 0.78, "ppi_degree": 110, "pubmed_count_5yr": 1400, "data_source": "fallback_gold"},
    "PSEN1":  {"gwas_pval_log10": 18.6, "n_gwas_studies": 7,  "disease_area": "neurological",   "disease_name": "Alzheimer's disease",        "burden_daly_m": 28.0,  "open_targets_score": 0.76, "druggability_score": 0.90, "eqtl_effect": 0.58, "mr_z_score": 4.4, "tissue_specificity": 0.78, "ppi_degree": 110, "pubmed_count_5yr": 1500, "data_source": "fallback_gold"},
    "APP":    {"gwas_pval_log10": 17.4, "n_gwas_studies": 6,  "disease_area": "neurological",   "disease_name": "Alzheimer's disease",        "burden_daly_m": 28.0,  "open_targets_score": 0.73, "druggability_score": 0.90, "eqtl_effect": 0.55, "mr_z_score": 4.1, "tissue_specificity": 0.78, "ppi_degree": 110, "pubmed_count_5yr": 1300, "data_source": "fallback_gold"},
    "GBA":    {"gwas_pval_log10": 20.4, "n_gwas_studies": 8,  "disease_area": "neurological",   "disease_name": "Parkinson's disease",        "burden_daly_m": 28.0,  "open_targets_score": 0.78, "druggability_score": 0.90, "eqtl_effect": 0.61, "mr_z_score": 4.7, "tissue_specificity": 0.78, "ppi_degree": 110, "pubmed_count_5yr": 1700, "data_source": "fallback_gold"},
    "APOE":   {"gwas_pval_log10": 23.1, "n_gwas_studies": 10, "disease_area": "neurological",   "disease_name": "Alzheimer's disease",        "burden_daly_m": 28.0,  "open_targets_score": 0.82, "druggability_score": 0.90, "eqtl_effect": 0.67, "mr_z_score": 5.1, "tissue_specificity": 0.78, "ppi_degree": 180, "pubmed_count_5yr": 3100, "data_source": "fallback_gold"},
}
...
def run_fallback():
    ...
    gold_features  = FALLBACK_GOLD_FEATURES
    orphan_genes  = FALLBACK_ORPHAN
    return gold_standard, gold_features, orphan_genes
...
def main():
    ...
    if args.fallback:
        gold_standard, gold_features, orphan_genes = run_fallback()
    else:
        ...
        # Enrich gold genes with real features — seed from curated metadata
        print("\n=== Enriching gold standard genes with real API features ===")
        gold_seed = {}
        for gene, info in gold_standard.items():
            area = info.get("area", info.get("disease_area", "neurological"))
            gs   = float(info.get("genetics_score", 0.7))
            gold_seed[gene] = {
                "gwas_pval_log10": round(gs * 30.0, 2),
                "n_gwas_studies":  8,
                "disease_area":    area,
                "disease_name":    info["disease"],
                "burden_daly_m":   BURDEN_MAP.get(area, 28.0),
            }
        gold_features = phase3_enrich(gold_seed)
    ...
    write_data_py(gold_standard, gold_features, orphan_genes)
