"""scorer.py — fine-tune: OT score boost — auto-written by agent.py"""

WEIGHTS = {
    "mr_z_score": 3.0,
    "druggability_score": 2.5,
    "open_targets_score": 4.0,
    "gwas_pval_log10": 0.8,
    "n_gwas_studies": 3.0,
...
INTERACTION_TERMS = [('mr_z_score', 'druggability_score', 3.5), ('eqtl_effect', 'open_targets_score', 2.5)]
